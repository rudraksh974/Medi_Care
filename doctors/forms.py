...
class DoctorProfileForm(forms.ModelForm):
    class Meta:
        model = Doctor
        fields = ['consultation_fee', 'location', 'phone', 'appointment_mode_preference', 'available', 'lat', 'lng', 'slot_duration', 'registration_year']
        widgets = {
            'consultation_fee': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'step': '50', 'placeholder': 'Consultation fee in ₹ (e.g. 500)'}),
